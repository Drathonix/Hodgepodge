...
public class MixinGraviAdvancedLappackDEIntegration implements DEConfigurableExt, IConfigurableItem {
    ...
    public List<ItemConfigField> getFields(ItemStack stack, int slot) {
        ...
        fields.add(
                new AdvancedItemConfigField(References.INT_ID, slot, "toolMode", "gravisuite.Charging")
                        .representAs(References.BOOLEAN_ID).readFromItem(stack, 1).setMinMaxAndIncromente(0, 1, 1));
        return fields;
    }
